 ...
 * Use the [ShoppingCartDialogFragment.newInstance] factory method to
...
class ShoppingCartDialogFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ShoppingCartDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ShoppingCartDialogFragment().apply {
